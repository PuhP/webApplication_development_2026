...
% Определение данных
\newcommand{\theme}{%
    Разработка веб-приложения для управления очередью студентов на защиту лабораторных работ%
}
\newcommand{\subject}{Разработка веб-приложений}
\newcommand{\student}{Дудченко Алёна Алексеевна и Факов Станислав Юрьевич}
