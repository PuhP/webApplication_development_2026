...
\begin{longtable}{|P{0.5\textwidth}|C{0.11\textwidth}|C{0.15\textwidth}|C{0.24\textwidth}|}
  ...
  \multicolumn{4}{|P{\textwidth}|}{\textbf{Раздел 1. Анализ предметной области}} \\ \hline
    Задача 1.1. Сравнительный анализ существующих платформ для поиска учебных партнеров & 10 & 30.03.2026 & \\ \hline
    ...
    Задача 2.1. Анализ целевой аудитории и построение User Stories & 5 & 20.04.2026 & \\ \hline
    Задача 2.2. Разработка диаграммы вариантов использования (UML Use Case) & 7 & 27.04.2026 & \\ \hline
    Задача 2.3. Проектирование схемы базы данных (ER-диаграмма) & 8 & 04.05.2026 & \\ \hline
    Задача 2.4. Создание макетов интерфейса основных страниц (Wireframes) & 5 & 11.05.2026 & \\ \hline

    \multicolumn{4}{|P{\textwidth}|}{\textbf{Раздел 3. Разработка веб-приложения}} \\ \hline
    Задача 3.1. Реализация структуры проекта и базовых моделей данных на SQLAlchemy & 10 & 18.05.2026 & \\ \hline
    Задача 3.2. Разработка модуля профилей пользователей и системы тегов компетенций & 10 & 25.05.2026 & \\ \hline
    Задача 3.3. Реализация алгоритма сопоставления пользователей по навыкам & 10 & 01.06.2026 & \\ \hline
    Задача 3.4. Создание пользовательского интерфейса с использованием Jinja2 & 10 & 08.06.2026 & \\ \hline

    \multicolumn{4}{|P{\textwidth}|}{\textbf{Раздел 4. Оформление итогов работы}} \\ \hline
    Задача 4.1. Тестирование функциональности и управление версиями в Git & 3 & 10.06.2026 & \\ \hline
    Задача 4.2. Развертывание приложения (деплой) & 3 & 12.06.2026 & \\ \hline
    Задача 4.3. Оформление пояснительной записки в формате LaTeX & 4 & 13.06.2026 & \\ \hline
\end{longtable}
}
