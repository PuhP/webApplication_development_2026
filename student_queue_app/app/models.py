...
class Subject(db.Model):
    ...
    lab_count = db.Column(db.Integer, nullable=False, default=10, server_default="10")
    minutes_per_lab = db.Column(db.Integer, nullable=False, default=15, server_default="15")
